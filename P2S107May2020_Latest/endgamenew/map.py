...
class Game(Widget):
    ...
    def serve_car(self):
        ...
        #print(self)
        #print("velocity" + str(self.car.velocity) + "selfcenter" + str(self.center)+"carcenter" +  str(self.car.center)) 

    def get_obs(self, xx, yy):
        global goal_x
        global goal_y
        area = (self.car.x-35,self.car.y-35,self.car.x+35,self.car.y+35)
        iobj = img.rotate(90,expand=True).crop(area)
        
        iobj = iobj.rotate(self.car.angle,expand=True)
        #img2 = PILImage.open("./images/car.png").resize((20,10))
        #iobj.paste(img2,(40,40))
        ...
        return iobj, orientation, distance
    ...
    def update(self,dt):
        ...
        if first_update:
            ...
            if len(filename) > 0:
                self.serve_car()
        observationspace, orientation, distance = self.get_obs(self.car.x,self.car.y)
        if len(filename) > 0:
            ...
            if done:
                ...
                if total_timesteps != 0:
                    ...
                    file1.write("Total Timesteps: {} Episode Num: {} Reward: {}".format(total_timesteps, episode_num, episode_reward))
                    file1.write("\n")
                    file1.close()
        ...
        # If the explore_noise parameter is not 0, we add noise to the action and we clip it
            ...
            replay_buffer.add((observationspace, new_obs, action, reward, done , orientation, new_orientation,distance,new_distance))
